...
- [Canonical literature](../references/canonical-literature.md)：用于回查 DFT foundations、pseudopotential / relativistic treatment、DFT+U 与 reproducibility 的文献骨架。
- [SOC and symmetry boundary](soc-and-symmetry-boundary.md)：本目录中更具体的 SOC/noncollinear output evidence、fully relativistic PP 和 symmetry/k-path 数据链边界。
