...
路由说明：本页是 EPC data-chain quick card；EPC 物理判断的系统背景读 [14-electron-phonon-coupling-physical-judgement.md](14-electron-phonon-coupling-physical-judgement.md)，Wannier 前置验证读 [wannier-validation-and-window-choice.md](wannier-validation-and-window-choice.md)。
...
- 不能把粗网格 EPC 当作最终 mobility、resistivity 或 superconductivity 结果。
