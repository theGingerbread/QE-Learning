...
![PASS WARN BLOCK downstream gate](../assets/diagrams/physics-judgement/pass-warn-block-gate.svg)

图：`PASS / WARN / BLOCK` 是由 output evidence、source boundary 和当前目标共同决定的下游 gate。该图只说明审阅流程，不替代具体 workflow 的 output review。
