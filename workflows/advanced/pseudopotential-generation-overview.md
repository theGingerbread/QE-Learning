# Pseudopotential Generation Overview workflow
...
说明 `ld1.x`/`atomic` 赝势生成的学习边界、验证要求和记录规范。
...
<namelist_or_cards>
  calculation_or_task = 'pseudopotential-generation-overview'
  prefix = '<system>'
  outdir = '<scratch_dir>'
...
- QE atomic package documentation: <https://www.quantum-espresso.org/documentation/>
