...
说明 QE 到 Wannier90 的接口边界、投影/冻结窗口和插值结果审阅。
...
<namelist_or_cards>
  calculation_or_task = 'wannier90-overview'
  prefix = '<system>'
  outdir = '<scratch_dir>'
...
- QE pw2wannier90 input reference: <https://www.quantum-espresso.org/Doc/INPUT_pw2wannier90.html>
