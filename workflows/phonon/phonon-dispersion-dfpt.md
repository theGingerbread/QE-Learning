...
- 已决定 Gamma phonon、q-grid dispersion、phonon DOS 或 dielectric/Born charge 分支。
...
- Dielectric tensor / Born charge branch:
- Warnings:
- PASS / WARN / BLOCK:
- Reason:
...
| LO-TO 分裂异常 | `epsil`、Born charges、非解析项处理不完整 | 仅在有效物理条件下使用并记录方向 |
...
- 补充 `epsil`、Born charge、dielectric tensor 的适用条件。
